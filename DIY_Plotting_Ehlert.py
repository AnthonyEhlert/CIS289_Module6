...
vid_game_sales_by_genre_df = base_video_game_df[
    ['Genre', 'NA_Sales', 'EU_Sales', 'JP_Sales', 'Other_Sales', 'Global_Sales']].copy()
...
total_height = [sum(x) for x in
                zip(fig1_na['NA_Sales'].tolist(), fig2_eu['EU_Sales'].tolist(), fig3_jp['JP_Sales'].tolist(),
                    fig4_other['Other_Sales'].tolist())]
